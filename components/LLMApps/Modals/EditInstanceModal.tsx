...
import { editCanister, editICPWallet, editWallet } from '@/utils/api-blockchain'
...
const EditCanisterModal = ({
  ...
  const [appName, setAppName] = useState(llmInstance.name)
  ...
  const handleEditApp = async () => {
    ...
    try {
      await editLLMInstance(final, userSessionToken)
      setIsLoading(false)
      onUpdateM()
    } catch (err) {
      console.log(err)
...
export default EditCanisterModal
