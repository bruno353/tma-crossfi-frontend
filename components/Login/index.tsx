              ...
              <div className="w-full px-4">
                <div className="mx-auto max-w-[500px] rounded-md bg-primary bg-opacity-5 px-6 py-10 dark:bg-dark sm:px-[60px]">
                  ...
                  <div className="mb-6 flex w-full items-center justify-center rounded-md bg-white p-3 text-base font-medium text-body-color shadow-one hover:text-primary dark:bg-[#242B51] dark:text-body-color dark:shadow-signUp dark:hover:text-white">
                    ...
                    <svg
                      aria-hidden="true"
                      className="my-auto mr-3 h-6 w-6 animate-spin fill-[#273687] text-[#242B51]"
                      viewBox="0 0 100 101"
                      fill="none"
                  ...
                  <svg
                    aria-hidden="true"
                    className="my-auto mr-3 h-6 w-6 animate-spin fill-[#273687] text-opacity-0"
                    viewBox="0 0 100 101"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                  ...
                  <svg
                    aria-hidden="true"
                    className="my-auto mr-3 h-6 w-6 animate-spin fill-[#273687] text-[#000]"
                    viewBox="0 0 100 101"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
